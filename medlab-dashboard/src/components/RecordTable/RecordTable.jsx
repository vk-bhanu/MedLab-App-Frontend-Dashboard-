...
const RecordTable = () => {
  ...
  const markAsDone = async (id) => {
    try {
      const response = await fetch(`https://medlab-app-backend-server.vercel.app/${id}`, {
        method: "PATCH",
  ...
  const deleteBooking = async (id) => {
    try {
      const response = await fetch(`https://medlab-app-backend-server.vercel.app/booktest/${id}`, {
        method: "DELETE",
      });
